...
# --- 2. データ定義 ---
BELONGINGS = {"現国": ["教科書「現代の国語」", "ノート", "電子辞書", "大学入試に出た核心漢字2500+語彙1000", "論理エンジンスパイラルレベル⑧-1", "力をつける現代文ステップ1.5"],"言語文化": ["教科書「言語文化」", "ノート", "電子辞書", "完全マスター古典文法＆準拠ノート, "グランステップ1.5", "漢文必携"],"地総": ["教科書「新地理総合」", "地図帳「新詳高等地図」"], "歴総": ["教科書「歴史総合」", "副教材「歴史総合ワークノート」"],"数基α": ["教科書「NEXT数学I」", "ノート", "CONNECT「数学I+A」", "Focus Gold", "完成ノート", "短期完成ノート"],"数基β": ["教科書「数学A」", "ノート", "CONNECT数学I+A", "Focus Gold", "完成ノート", "短期完成ノート"],"科技α": ["教科書「物理基礎」", "副教材「セミナー物理基礎」", "ノート"], "科技β": ["教科書「生物基礎」", "問題集「リードα 生物基礎」", "コンセプトノート 生物基礎"],"保健": ["教科書「現代高等保健体育」", "図説現代高等保健"], "体育": ["体操服", "イラストでみる最新スポーツルール'26"],"コミュ I": ["Heartening教科書", "LEAP", "Cutting Edge Yellow本体", "Navi Book"],"論表": ["EARTHRISE教科書", "GRAND EARTH 新々総合英語", "GRAND EARTH 48 Stages Workbook", "Focus on Listening Pre-Standard(月曜日のみ)", "Focus on Listening Standard(Preの後)"],"SP I": ["Heartening教科書"],"家庭": ["教科書「新図説 家庭基礎」", "2026 生活学Navi", "ファイル"],"探求基礎": ["課題研究メソッド"],"LT": ["（特になし）"]}
